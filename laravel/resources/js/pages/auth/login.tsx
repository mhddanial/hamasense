                ...
                {({ processing, errors }) => (
                    <>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <p className="text-xs text-center text-gray-500 uppercase">atau</p>
                            <span className="w-1/5 border-b lg:w-1/4"></span>
                        </div>

                        <a href='/auth/google/redirect' className="flex items-center justify-center text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50">
                            <div className="py-2">
