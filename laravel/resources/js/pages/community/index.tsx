...
import { Search, Plus, Hash, MessageSquare, Bookmark } from 'lucide-react';
...
export default function KomunitasPage({ initialPosts = [], categories = [] }: { initialPosts?: any[], categories?: Category[] }) {
  ...
  const filteredPosts = posts.filter(post => {
    // Filter by saved
    if (showSavedOnly && !post.isBookmarked) {
      return false;
    }
