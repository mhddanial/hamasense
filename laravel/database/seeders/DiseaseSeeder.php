...
class DiseaseSeeder extends Seeder
{
    ...
    {
        $sqlPath = database_path('sql/diseases.sql');
        
        if (file_exists($sqlPath)) {
            $sql = file_get_contents($sqlPath);
            
            // Split by semicolon at end of statement (followed by newline or end)
            // This handles multi-line INSERT statements with semicolons in data values
            ...
            $this->command->info('Diseases seeded from SQL file.');
        } else {
